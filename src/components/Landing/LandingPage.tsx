  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-24 pb-20 overflow-hidden">
        ...
        {/* Gradient Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-purple-50 via-violet-50 to-blue-50 opacity-60"></div>
        ...
        <div className="absolute bottom-0 right-1/4 w-80 h-80 bg-gradient-to-r from-violet-400/20 to-blue-400/20 rounded-full blur-3xl"></div>

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center space-x-2 bg-purple-100/80 text-purple-700 px-4 py-2 rounded-full text-sm font-medium mb-8 backdrop-blur-sm">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 leading-tight mb-8">
            Slay Your
            <span className="bg-gradient-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent"> Subscription </span>
            Chaos
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6 mb-16">
            ...
            <button className="text-purple-600 hover:text-purple-700 font-semibold text-lg flex items-center space-x-2 transition-colors">
              ...
              <div className="w-12 h-12 bg-purple-100 hover:bg-purple-200 rounded-full flex items-center justify-center transition-colors">
                <ArrowRight className="w-5 h-5" />
              </div>
            </button>
          </div>
