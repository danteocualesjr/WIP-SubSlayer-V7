...
async function sendTestEmail() {
  try {
    ...
    const emailSubject = 'SubSlayer: Upcoming Subscription Renewal Alert';
    ...
    const emailHtmlContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
        ...
        <div style="background-color: #f9f5ff; border-left: 4px solid #8B5CF6; padding: 15px; margin-bottom: 20px; border-radius: 5px;">
          <h2 style="color: #4B5563; margin-top: 0;">Urgent Subscription Renewal</h2>
          <p style="color: #4B5563;">Your <strong>Disney+</strong> subscription will renew in <strong>2 days</strong>.</p>
        </div>
        
        <div style="margin-bottom: 20px;">
          <h3 style="color: #4B5563;">Subscription Details:</h3>
          <ul style="color: #4B5563; padding-left: 20px;">
            <li><strong>Service:</strong> Disney+</li>
        ...
        <div style="background-color: #f0f9ff; border-left: 4px solid #3B82F6; padding: 15px; margin-bottom: 20px; border-radius: 5px;">
          ...
          <p style="color: #4B5563;">If you want to cancel this subscription, visit <a href="https://www.disneyplus.com/account/cancel-subscription" style="color: #3B82F6; text-decoration: none;">Disney+'s cancellation page</a>.</p>
        </div>
        
        <div style="text-align: center; margin-top: 30px;">
          <a href="https://subslayer.app" style="background-color: #8B5CF6; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Manage Your Subscriptions</a>
        </div>
